					...
					<div class="row">
                        ...
                        <div class="col-lg-4">	
							<div class="single-cat">
								<a href="#" class="hb-sm-margin mx-auto d-block"><span class="hb hb-sm inv hb-facebook-inv"><span class="lnr lnr-cloud-sync"></span></span></a>
								<h4 class="mt-40 mb-20">Software Innovation</h4>
								<p>
									inappropriate behavior is often laughed off as “boys will be boys,” women face higher conduct standards especially in the workplace. That’s why.
								</p>
							</div>															
						...
						<div class="col-lg-4">	
							<div class="single-cat">
								...
								<h4 class="mt-40 mb-20">Entertainment</h4>
								<p>
									inappropriate behavior is often laughed off as “boys will be boys,” women face higher conduct standards especially in the workplace. That’s why.
								</p>
							</div>															
						...
						<div class="col-lg-4">
							<div class="single-cat">
								...
								<h4 class="mt-40 mb-20">Business Solutions</h4>
								<p>
									inappropriate behavior is often laughed off as “boys will be boys,” women face higher conduct standards especially in the workplace. That’s why.
								</p>
							</div>							

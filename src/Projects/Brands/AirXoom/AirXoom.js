...
export default function VibeClubs(){
    return(
        <div>
            <Banner heading="AirXoom" cssClass = "airxoom"/>
       	<section class="blog-posts-area section-gap">
				<div class="container">
                    ...
                    <img class="img-fluid" src="img/airxoom-logo.jpeg" alt="" />		
									...
									<p>
                                    Airxoom is a portal that is designed to get the best rates for Business and
                                    Personal Logistics when you having to move your goods in a Hurry we compare
                                    the rates on over 200 airlines.
									</p>

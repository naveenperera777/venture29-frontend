...
export default function VibeClubs(){
    return(
        <div>
            <Banner heading="United Car Center" cssClass = "united-cars"/>
       	<section class="blog-posts-area section-gap">
				<div class="container">
					<div class="row">
                    <div class="col-lg-8 post-list blog-post-list">
                    <div class="single-post">
                    <img class="img-fluid" src="img/imperialceylon-product-image.jpeg" alt="" />		
								
									<h1>
										United Car Center, Driving is Believing
									</h1>
                                    <div class="content-wrap">
									<p>
                                    Car dealer with a personal touch!
									</p>

...
export default function VibeClubs(){
    return(
        <div>
            <Banner heading="EEVOLUZION" cssClass = "eevolution"/>
       	<section class="blog-posts-area section-gap">
				<div class="container">
					<div class="row">
                    <div class="col-lg-8 post-list blog-post-list">
                    <div class="single-post">
                    <img class="img-fluid" src="img/eevolution.jpeg" alt="" />		
									...
									<p>
                                    EEVOLUZION is simply Electric Mobility Company of the future allowing
                                    travellers to become carbon neutral. Our one of they first key innovations
                                    includes the Dragonfly 2020, which is designed for city travellers to travel to

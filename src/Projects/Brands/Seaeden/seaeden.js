...
export default function Seaeden(){
    return(
        <div>
            <Banner heading="Seaeden" cssClass = "seaeden"/>
       	<section class="blog-posts-area section-gap">
				<div class="container">
                    ...
                    <img class="img-fluid" src="img/seaeden-product-image.jpeg" alt="" />		
									...
									<p>
                                    This is a “Glamping” project which allows holiday makers to enjoy their stay
                                    away from the hustle and the bustle and to be one with the nature. These eco
                                    friendly Yurts are located in breathtaking locations to attract clients who likes to
                                    enjoy out door activities such as hiking, cycling, yoga and many more. All our
                                    location serves organic food and all the locations are carefully selected to give all
                                    our clients a magical experience.
									</p>
                                ...
                                <div class="container">
                                    ...
                                    <div class="row flex-row d-flex">
                                        ...
                                        <div class="col-lg-8 col-md-6">
                                            ...
                                            <a class="primary-btn mt-20" href="#">Send</a>
                                        </div>
                                    </div>
                                </div>    
                            </section>         
